...
@else
    <div class="{{ data_get($theme, 'baseClass') }} me-1" style="{{ data_get($theme, 'baseStyle') }}">
        <select style="{{ data_get($column, 'headerStyle') }}" class="tb-rounded form-select form-select-sm "
